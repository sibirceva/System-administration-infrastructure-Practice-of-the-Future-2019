            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item"><a href="/type/view">Список типов вещей</a></li>
                        ...
                        <li class="list-group-item"><a href="/user/edit/3">Изменить адрес почты для уведомлений</a></li>
